...
local function moveText( )
    loseText.alpha = loseText.alpha + 0.0079
    loseText.x = loseText.x + motionx
end
...
function scene:create( event )
    ...
    -- Display background
    bkg = display.newImage("Images/loseBackground.png")
    ...
    loseText = display.newImage("Images/loseText.png")
    loseText.x = -2
    loseText.y = 384
    loseText.width = 1024
    loseText.height = 768
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        if (soundOn == true) then 
            -- play sound effect 
            youLoseSoundChannel = audio.play(youLoseSound, {channel = 2, loops = 1})
        end
    end
end
